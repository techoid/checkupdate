    ...
    return <>
        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 contact-us-btn-components-display-width">
            <div className="contact-us-section-div-button">
                <h1 className="contact-us-section-button-heading-bottom">Let’s have a chat</h1>
                <form action="" method="POST" encType="multipart/form-data">
                    ...
                    <div className="row contact-us-section-button-margin-bottom">
                        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 our-partners-check-padding">
                            <div className="contact-us-section-button-flex-column">
                                <label className="contact-us-section-button-label" for="inquirytype">Inquiry Type <span className="contact-us-section-button-span">*</span></label>
                                <div className="custom-select select-items-width">
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 our-partners-check-margin our-partners-check-padding">
                            <div className="contact-us-section-button-flex-column">
                                <label className="contact-us-section-button-label" for="contact">How should we contact you? <span className="contact-us-section-button-span">*</span></label>
                                <div className="custom-select select-items-width">
                    ...
                    <div className="row contact-us-section-button-margin-bottom">
                        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 our-partners-check-margin our-partners-check-padding">
                            <center><input className="btn btn-primary contact-us-section-button-components-title-row-col" type="button" name="button-submit" value="Subscribe" id="button-submit" /></center>
                        </div>
                    </div>
                </form>
            </div>
