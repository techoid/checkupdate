...
function seopages() {
    return <>
        ...
        <FooterTop />
        <section>
            <DetailsComponent title="Meal Plans Service in Abu Dhabi" images={'seopagebg.jpg'} />
            <div className="container section-container container-fluid-check">
                <div className="row">
                    <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h1 className="section-heading">Meal Plan Abu Dhabi</h1>
                        <p className="section-paraghic">Meal planning is an easy method to make the process easier, whether you’re looking to lose weight or simply improve your diet. Prepping your meals in advance has many advantages, including saving money and improving your overall health. This also keeps you from binge eating at eateries, where the portions are usually much larger than you would otherwise eat.<br /><br />
